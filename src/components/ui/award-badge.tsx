...
import logoImg from '../../assets/timefall-logo.png';
...
export const AwardBadge = ({ type = "golden-kitty", place, link }: AwardBadgeProps) => {
  ...
  return (
    <div
      ref={ref}
      className="block w-[180px] sm:w-[260px] h-auto cursor-default"
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="w-180px sm:w-260px h-auto">
          ...
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize="9" fontWeight="bold" fill="#666" x="79" y="20">
            DESIGNED BY
          </text>
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize="16" fontWeight="bold" fill="#666" x="78" y="40">
            TIMEFALL STUDIOS
          </text>
          <g transform="translate(18, 5)">
            <image href={logoImg} width="44" height="44" />
          </g>
